                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                      ...
                                      <div <?php if($numPage <2) echo "style='display: none;'"; ?> class="pagination flex-m flex-w p-t-26">
                                        ...
                                        <a href="index.php?area=backend&controller=product&p=<?php echo $i; ?>" class="item-pagination flex-c-m trans-0-4 <?php if($i == $page) echo ' active-pagination'; ?>"><?php echo $i; ?>&nbsp;</a>
                                        <?php endfor; ?>
